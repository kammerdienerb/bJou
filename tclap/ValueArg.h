        ...
        if ( Arg::delimiter() != ' ' && value == "" )
			...
			throw( ArgParseException( 
							"Couldn't find delimiter for this argument!",
                             toString() ) );
#else
        assert(false && "Couldn't find delimiter for this argument!");
#endif
        ...
        if ( value == "" )
        {
            ...
            if ( static_cast<unsigned int>(*i) < args.size() ) 
				...
				throw( ArgParseException("Missing a value for this argument!",
                                                    toString() ) );
#else
            assert(false && "Missing a value for this argument!");
#endif
        }
        else
			_extractValue( value );
...
void ValueArg<T>::_extractValue( const std::string& val ) 
{
	...
	if ( err == VALUE_ARG_HELPER::EXTRACT_FAILURE )
		...
		throw( ArgParseException("Couldn't read argument value from string '" +
	                             val + "'", toString() ) );
#else
    assert(false && "Couldn't read argument value from string");
#endif
	...
	if ( err == VALUE_ARG_HELPER::EXTRACT_TOO_MANY )
		...
		throw( ArgParseException(
				    ...
				    val + "'", toString() ) );
#else
    assert(false && "More than one valid value parsed from string");
#endif
	...
	if ( _constraint != NULL )
		if ( ! _constraint->check( _value ) )
			...
			throw( CmdLineParseException( "Value '" + val + 
										  ...
										  toString() ) );
#else
    assert(false && "Value does not meet constraint.");
#endif
}
