...
ArgSet::ArgSet(bool _verbose_arg, bool _front_arg, bool _time_arg,
               ...
               const std::string & _output_arg, const std::string & _target_triple_arg, const std::string & _march_arg, const std::vector<std::string> & _link_arg,
    ...
    : verbose_arg(_verbose_arg), front_arg(_front_arg), time_arg(_time_arg),
      ...
      target_triple_arg(_target_triple_arg), march_arg(_march_arg), link_arg(_link_arg), files(_files) { }
