...
RP_FUNCTOR_DECL_BL(Struct_InterfaceImpl);
RP_FUNCTOR_DECL_BL(InterfaceDef_Proc);
RP_FUNCTOR_DECL(InterfaceImplementation_Identifier);
RP_FUNCTOR_DECL_BL(InterfaceImplementation_Proc);
...
RP_FUNCTOR_DECL_BL(Namespace_Node);
