...
CC 			= g++
INCLUDE		= include
R_CFLAGS 	= -I$(INCLUDE) -DBJOU_USE_COLOR -fPIC -fvisibility-inlines-hidden -Wall -W -Wno-unused-parameter -Wwrite-strings -Wcast-qual -Wmissing-field-initializers -pedantic -Wno-long-long -Wcovered-switch-default -Wnon-virtual-dtor -Wdelete-non-virtual-dtor -Wstring-conversion -Werror=date-time -std=c++11 -O3 -DNDEBUG -flto -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS
D_CFLAGS 	= -I$(INCLUDE) -DBJOU_USE_COLOR -DBJOU_DEBUG_BUILD -g -fPIC -fvisibility-inlines-hidden -std=c++11 -DNDEBUG -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS
...
SRC			+= $(wildcard tclap/*.cpp)
R_OBJ 		= $(patsubst %.cpp,release/obj/%.o,$(SRC))
D_OBJ 		= $(patsubst %.cpp,debug/obj/%.o,$(SRC))
